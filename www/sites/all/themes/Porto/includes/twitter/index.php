	...
	private function getTwitterJSON() {
	  define('DRUPAL_ROOT', getcwd() . '/../../../../../../');
		...
		$tmhOAuth = new tmhOAuth(array(
			...
			'consumer_key'          => theme_get_setting('twitter_app_consumer_key'),
			'consumer_secret'       => theme_get_setting('twitter_app_consumer_secret'),
			'user_token'            => theme_get_setting('twitter_app_access_token'),
			'user_secret'           => theme_get_setting('twitter_app_access_secret'),
